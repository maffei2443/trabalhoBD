...
-- Mon 18 Jun 2018 01:09:44 PM -03
...
CREATE TABLE IF NOT EXISTS `mydb`.`Local` (
  ...
  `estatistica_partidaria` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Prefeito` (
  `idPrefeito` INT NOT NULL,
  `Cargo` INT NOT NULL,
  `Vice` TINYINT(1) NOT NULL,
